...
- You are not allowed to import any module
```
root@c54b1b2b8256:/alx-higher_level_programming/0x01-python-if_else_loops_functions# ./4-print_hexa.py
0 = 0x0
1 = 0x1
2 = 0x2
3 = 0x3
...
- You are not allowed to import any module
```
root@c54b1b2b8256:/alx-higher_level_programming/0x01-python-if_else_loops_functions# ./5-print_comb2.py
